...
- [x] 1.1 Extractor unit tests pass across isolation, non-HTML, markers, blocks, digest and the too-short guard — d3f1ea6
- [x] 1.2 Identical normalised text produces identical digests across differing markup whitespace — d3f1ea6
- [x] 1.3 `TODO` in page text produces no marker — d3f1ea6
- [x] 1.4 Existing crawler, politeness and run tests pass with updated page counts — d3f1ea6
- [x] 1.5 Type checking passes: `npm run typecheck` — d3f1ea6
- [x] 1.6 Linting passes: `npm run check` — d3f1ea6
- [x] 1.7 Whole suite passes: `npm run test:all` — d3f1ea6
...
- [x] 2.1 A page with an unrendered template marker produces exactly one finding — 24487d6
- [x] 2.2 A page whose content is identical to its sibling's produces exactly one finding, naming that sibling — 24487d6
- [x] 2.3 A family of honest translations produces no `content_untranslated` finding — 24487d6
- [x] 2.4 A broken page in a family produces no `content_untranslated` finding — 24487d6
- [x] 2.5 A page below the comparable-length floor produces no sibling finding — 24487d6
- [x] 2.6 A truncated crawl produces no sibling findings — 24487d6
- [x] 2.7 Mutation: removing the `isError` guard fails the broken-page case — 24487d6
- [x] 2.8 Mutation: comparing raw text instead of normalised text fails the whitespace case — 24487d6
- [x] 2.9 Every existing site-shape case passes unchanged — 24487d6
- [x] 2.10 `pagesInvolved` returns non-empty for the new type — 24487d6
- [x] 2.11 Type checking, linting and the whole suite pass — 24487d6
